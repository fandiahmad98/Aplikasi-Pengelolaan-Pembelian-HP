object FormTabelAdmin: TFormTabelAdmin
  Left = 245
  Top = 95
  Width = 939
  Height = 529
  Caption = 'FormTabelAdmin'
  ...
  object lbl2: TLabel
    ...
    Width = 112
    Height = 13
    Caption = 'Stock HP yang tersedia'
  end
  object lbl3: TLabel
    Left = 712
    Top = 8
    Width = 118
    Height = 13
    Caption = 'Admin yang sedang login'
  end
  object lbl4: TLabel
    Left = 24
    Top = 232
  ...
  object VarUni_sdbGrid_tabel: TSMDBGrid
    Left = 24
    Top = 32
    Width = 673
    Height = 153
    DataSource = DataModule2.ds1_016
    ...
    GridStyle.Title.EndColor = clSkyBlue
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Metode Pembayaran'
        Visible = True
      end
      item
        Expanded = False
  ...
  object VarUni_sDbNav_status: TSMDBNavigator
    Left = 136
    Top = 416
    Width = 280
    Height = 25
    DataSource = DataModule2.ds4_016
    ...
    ShowGlyph = True
    TabOrder = 1
    OnClick = VarUni_sDbNav_statusClick
  end
  object btn3_keluar: TButton
    Left = 32
    Top = 472
    Width = 75
    Height = 25
    Caption = 'Keluar'
    TabOrder = 2
    OnClick = btn3_keluarClick
  end
  object btn3_logout: TButton
    Left = 136
    Top = 472
    Width = 75
    Height = 25
    Caption = 'Log Out'
    TabOrder = 3
    OnClick = btn3_logoutClick
  end
  object VarUni_sdbGrid1_admin: TSMDBGrid
    Left = 712
    Top = 32
    Width = 168
    Height = 153
    DataSource = DataModule2.ds2_016
    Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
    TabOrder = 4
    TitleFont.Charset = DEFAULT_CHARSET
    TitleFont.Color = clWindowText
  ...
  object VarUni_sdbGrid3_stock: TSMDBGrid
    Left = 560
    Top = 248
    Width = 321
    Height = 153
    DataSource = DataModule2.ds3_016
    Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
    TabOrder = 5
    TitleFont.Charset = DEFAULT_CHARSET
    TitleFont.Color = clWindowText
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'Merk_HP'
        Title.Caption = 'Merk HP'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Tipe_HP'
        Title.Caption = 'Tipe HP'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Stock_Tersedia'
        Title.Caption = 'Stock Tersedia'
        Visible = True
      end>
  end
  object VarUni_sdbGrid4_status: TSMDBGrid
    Left = 24
    Top = 248
    Width = 497
    Height = 153
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'NIK_pembeli'
        Title.Caption = 'NIK Pembeli'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'nama_pembeli'
        Title.Caption = 'Nama Pembeli'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'HP_yang_dibeli'
        Title.Caption = 'HP yang dibeli'
        Visible = True
      end
      item
        Expanded = False
  ...
  object VarUni_sDbNav_stok: TSMDBNavigator
    Left = 584
    Top = 416
    Width = 280
    Height = 25
    ...
    ShowGlyph = True
    TabOrder = 7
    OnClick = VarUni_sDbNav_stokClick
  end
  object VarUni_sDbNav_pembeli: TSMDBNavigator
    Left = 24
    Top = 200
    Width = 280
    Height = 25
    ...
    ShowGlyph = True
    TabOrder = 8
    OnClick = VarUni_sDbNav_pembeliClick
  end
  object btn_statistik: TButton
    Left = 312
    Top = 200
    Width = 113
    Height = 25
    Caption = 'Lihat Statistik Data'
    TabOrder = 9
    OnClick = btn_statistikClick
  end
  object btn_sort: TButton
    ...
    Width = 129
    Height = 25
    Caption = 'Sorting Harga Ascending'
    TabOrder = 10
    OnClick = btn_sortClick
  end
  object btn_descending: TButton
    Left = 568
    Top = 200
    Width = 129
    Height = 25
    Caption = 'Sorting Harga Descending'
    TabOrder = 11
    OnClick = btn_descendingClick
  end
  object mxDBGridExport1_016: TmxDBGridExport
    ...
    Version = '2.37'
    DBGrid = VarUni_sdbGrid_tabel
    Left = 264
    Top = 472
  end
  object mxDBGridExport13_1: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'h:mm'
    DateTimeFormat = 'h:mm dd/MM/yyyy'
    ExportType = xtExcel
    ...
    Options = [xoClipboardMessage, xoFooterLine, xoHeaderLine, xoShowExportDate, xoShowHeader, xoShowProgress, xoUseAlignments]
    Version = '2.37'
    DBGrid = VarUni_sdbGrid3_stock
    Left = 320
    Top = 472
  end
  object mxDBGridExport14_1: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'h:mm'
    DateTimeFormat = 'h:mm dd/MM/yyyy'
    ExportType = xtExcel
